 ...
 * Defines spacing, typography, shadows, border radii, and other design tokens
 */
...
export const shadows = {
  ...
  focus: '0 0 0 3px rgba(66, 153, 225, 0.4)',
  // Elevated shadows for cards and modals
  card: '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)',
  cardHover: '0 20px 40px rgba(0, 0, 0, 0.12), 0 8px 16px rgba(0, 0, 0, 0.08)',
